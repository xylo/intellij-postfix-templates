...
<WAITING_TEMPLATE_VAR_NAME> {TEMPLATE_VARIABLE_CHAR}+       { yybegin(WAITING_TEMPLATE_VAR_NAME); return CptTypes.TEMPLATE_VARIABLE_NAME; }
<WAITING_TEMPLATE_VAR_NAME> {TEMPLATE_VARIABLE_SEPARATOR}   { yybegin(WAITING_TEMPLATE_VAR_EXPRESSION); return CptTypes.TEMPLATE_VARIABLE_SEPARATOR; }
<WAITING_TEMPLATE_VAR_NAME> {TEMPLATE_VARIABLE_START_CHAR}  { yybegin(WAITING_TEMPLATE_CODE); return CptTypes.TEMPLATE_VARIABLE_END; }
...
<WAITING_TEMPLATE_VAR_EXPRESSION> {TEMPLATE_VARIABLE_START_CHAR}  { yybegin(WAITING_TEMPLATE_CODE); return CptTypes.TEMPLATE_VARIABLE_END; }
...
<WAITING_TEMPLATE_VAR_VALUE> {TEMPLATE_VARIABLE_START_CHAR}  { yybegin(WAITING_TEMPLATE_CODE); return CptTypes.TEMPLATE_VARIABLE_END; }
