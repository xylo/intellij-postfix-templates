...
<YYINITIAL> {TEMPLATE_VARIABLE_FIRST_CHAR}                  { yybegin(WAITING_TEMPLATE_VAR); return CptTypes.TEMPLATE_VARIABLE; }
...
<WAITING_TEMPLATE_CODE> {TEMPLATE_CODE_FIRST_CHAR}{TEMPLATE_CODE_CHAR}* { yybegin(WAITING_TEMPLATE_CODE); return CptTypes.TEMPLATE_CODE; }

<WAITING_TEMPLATE_CODE> {TEMPLATE_VARIABLE_FIRST_CHAR}      { yybegin(WAITING_TEMPLATE_VAR); return CptTypes.TEMPLATE_VARIABLE; }


<WAITING_TEMPLATE_VAR> {TEMPLATE_VARIABLE_FIRST_CHAR}       { yybegin(WAITING_TEMPLATE_CODE); return CptTypes.TEMPLATE_VARIABLE; }

<WAITING_TEMPLATE_VAR> {TEMPLATE_VARIABLE_CHAR}             { yybegin(WAITING_TEMPLATE_VAR); return CptTypes.TEMPLATE_VARIABLE; }
