...
public class CustomPhpStringPostfixTemplate extends StringBasedPostfixTemplate implements NavigatableTemplate {
	...
	public static Condition<PsiElement> getCondition(final @NotNull String matchingClass, final @Nullable String conditionClass) {
		...
		if (psiElementCondition == null) {
			//psiElementCondition = PhpPostfixTemplatesUtils.isCustomClass(matchingClass);
		}
